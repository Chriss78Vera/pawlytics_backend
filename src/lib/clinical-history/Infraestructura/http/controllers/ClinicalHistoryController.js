const CreateClinicalHistoryDTO = require("../../../Aplicacion/dto/CreateClinicalHistoryDTO");
const CreateClinicalHistoryUseCase = require("../../../Aplicacion/use-cases/CreateClinicalHistoryUseCase");
const GetClinicalHistoriesUseCase = require("../../../Aplicacion/use-cases/GetClinicalHistoriesUseCase");
const GetClinicalHistoryByIdUseCase = require("../../../Aplicacion/use-cases/GetClinicalHistoryByIdUseCase");
const GetClinicalHistoryByPetUseCase = require("../../../Aplicacion/use-cases/GetClinicalHistoryByPetUseCase");
const UpdateClinicalHistoryUseCase = require("../../../Aplicacion/use-cases/UpdateClinicalHistoryUseCase");
const DeleteClinicalHistoryUseCase = require("../../../Aplicacion/use-cases/DeleteClinicalHistoryUseCase");
