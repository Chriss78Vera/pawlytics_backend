const CreateRoleDTO = require("../../../Aplicacion/dto/CreateRoleDTO");
const CreateRoleUseCase = require("../../../Aplicacion/use-cases/CreateRoleUseCase");
const GetRolesUseCase = require("../../../Aplicacion/use-cases/GetRolesUseCase");
const GetRoleByIdUseCase = require("../../../Aplicacion/use-cases/GetRoleByIdUseCase");
const UpdateRoleUseCase = require("../../../Aplicacion/use-cases/UpdateRoleUseCase");
const DeleteRoleUseCase = require("../../../Aplicacion/use-cases/DeleteRoleUseCase");
